...
public:
    ...
    ros::Publisher pubCurrentSurface;
    ros::Publisher pubMatchedCorner;
    ros::Publisher pubMatchedSurface;
    ...
    pcl::PointCloud<PointType>::Ptr currentMatchedCorners;
    pcl::PointCloud<PointType>::Ptr currentMatchedSurfaces;

    pcl::PointCloud<PointType>::Ptr mapMatchedCorners;
    pcl::PointCloud<PointType>::Ptr mapMatchedSurfaces;
    ...
    mapOptimization()
    {
        ...
        pubCurrentCorner = nh.advertise<sensor_msgs::PointCloud2>("test/currentCorner", 1);
        pubCurrentSurface = nh.advertise<sensor_msgs::PointCloud2>("test/currentSurface", 1);
        pubMatchedCorner = nh.advertise<sensor_msgs::PointCloud2>("test/matchedCorner", 1);
        pubMatchedSurface = nh.advertise<sensor_msgs::PointCloud2>("test/matchedSurface", 1);
    ...
    void allocateMemory()
    {
        ...
        currentMatchedCorners.reset(new pcl::PointCloud<PointType>());
        currentMatchedSurfaces.reset(new pcl::PointCloud<PointType>());

        mapMatchedCorners.reset(new pcl::PointCloud<PointType>());
        mapMatchedSurfaces.reset(new pcl::PointCloud<PointType>());
